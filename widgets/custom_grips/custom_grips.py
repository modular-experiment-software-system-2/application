...
class Widgets(object):
    def top(self, Form):
        ...
        self.top_left.setStyleSheet(u"background-color: rgb(13, 16, 21);")
        ...
        self.top_right.setStyleSheet(u"background-color: rgb(13, 16, 21);")
    ...
    def bottom(self, Form):
        ...
        self.bottom_left.setStyleSheet(u"background-color: rgb(13, 16, 21);")
        ...
        self.bottom_right.setStyleSheet(u"background-color: rgb(13, 16, 21);")
    ...
    def left(self, Form):
        ...
        self.leftgrip.setStyleSheet(u"background-color: rgb(0, 204, 255);")
